...
let MailerModule = MailerModule_1 = class MailerModule {
    static forRoot(options, connection) {
        return {
            ...
            imports: [mailer_core_module_1.MailerCoreModule.forRoot(options, connection)],
            exports: [mailer_core_module_1.MailerCoreModule],
        };
    }
    static forRootAsync(options, connection) {
        return {
            module: MailerModule_1,
            imports: [mailer_core_module_1.MailerCoreModule.forRootAsync(options, connection)],
            exports: [mailer_core_module_1.MailerCoreModule],
        };
    }
};
